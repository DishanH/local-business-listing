...
export default async function AdminCategoriesPage() {
  ...
  return (
    <AdminPageShell
      title="Categories"
      description={`${topLevel.length} top-level categories, ${[...childrenByParent.values()].reduce((n, list) => n + list.length, 0)} subcategories. Click a category below to edit it or manage its subcategories.`}
    >
                      ...
                      {subcategories.map((sub) => (
                        ...
                        >
                          <ToastForm
                            ...
                            successMessage="Subcategory saved"
                          ...
                          >
                            ...
                            <ToastButton
                              action={deleteCategory.bind(null, sub.id)}
